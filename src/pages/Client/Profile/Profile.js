        ...
        <div className="profile-page">
            <div className="profile">
                <div className="content">
                    ...
                    {defaultValues ? (
                        <FormRHF className="profile-form" onSubmit={handleSubmit} defaultValues={defaultValues}>
                            ...
                            <div className="input-wrapper">
                                <InputField
                                    ...
                                    type="tel"
                                    validators={{
                                        required: (v) => (checkIsBlank(v) ? 'Phone number is required' : null),
                                    }}
                                />
                            </div>
                            <div className="input-wrapper mw400">
                                <InputField
                                    ...
                                    type="date"
                                    validators={{
                                        required: (v) => (checkIsBlank(v) ? 'Date of birth is required' : null),
                                    }}
                                />
                            </div>
                            ...
                            <div className="input-wrapper mw400">
                                <SelectField
                                    ...
                                    label="Gender"
                                    validators={{
                                        required: (v) => (v ? undefined : 'Gender is required'),
                                    }}
                                    options={[
                            ...
                            <div className="actions">
                                <Button type="submit" text="Save Changes" className="btn-save" />
                            </div>
                        </FormRHF>
                    ) : (
                        <p>Loading...</p>
